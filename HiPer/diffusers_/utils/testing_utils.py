...
def torch_all_close(a, b, *args, **kwargs):
    ...
    if not torch.allclose(a, b, *args, **kwargs):
        raise AssertionError(f"Max diff is absolute {(a - b).abs().max()}. Diff tensor is {(a - b).abs()}.")
    return True
...
def pytest_terminal_summary_main(tr, id):
    ...
    def summary_failures_short(tr):
        ...
        for rep in reports:
            ...
            longrepr = re.sub(r".*_ _ _ (_ ){10,}_ _ ", "", rep.longreprtext, count=0, flags=re.M | re.S)
