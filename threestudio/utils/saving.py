...
class SaverMixin:
    ...
    def get_grayscale_image_(self, img, data_range, cmap):
        ...
        if cmap is None:
            ...
            def blend_rgba(image):
                image = image[..., :3] * image[..., -1:] + (1.0 - image[..., -1:])  # blend A to RGB
                return image
    ...
    def save_obj(
        ...
        map_Kd: Optional[Float[Tensor, "..."]] = None,
        map_Ks: Optional[Float[Tensor, "..."]] = None,
        map_Bump: Optional[Float[Tensor, "..."]] = None,
        map_Pm: Optional[Float[Tensor, "..."]] = None,
        map_Pr: Optional[Float[Tensor, "..."]] = None,
        map_format: str = "jpg",
    ) -> List[str]:
        save_paths: List[str] = []
