...
class BaseLift3DSystem(BaseSystem):
    ...
    def on_fit_start(self) -> None:
        if self._save_dir is not None:
            ...
            threestudio.warn("Saving directory not set for the system, visualization results will not be saved")
    ...
    def guidance_evaluation_save(self, comp_rgb, guidance_eval_out):
        ...
        def f(x):
            F.interpolate(x.permute(0, 3, 1, 2), (size, size), mode="bilinear", align_corners=False).permute(
                0, 2, 3, 1
            )
