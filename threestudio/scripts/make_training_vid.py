...
def join(file1, file2, name):
    ...
    for f1, f2 in zip(vid1, vid2):
        frames.append(np.concatenate([f1[:, : f1.shape[0]], f2[:, : f2.shape[0]]], axis=1))
...
if __name__ == "__main__":
    ...
    parser.add_argument("--frames_per_vid", type=int, default=1, help="# of frames from each val vid")
    ...
    make_training_vid(args.exp, args.frames_per_vid, args.fps, args.max_iters, args.max_vids)
