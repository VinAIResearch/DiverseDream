...
class IsosurfaceHelper(nn.Module):
    ...
    @property
    def grid_vertices(self) -> Float[Tensor, "..."]:
...
class MarchingCubeCPUHelper(IsosurfaceHelper):
    def __init__(self, resolution: int) -> None:
        ...
        self._grid_vertices: Optional[Float[Tensor, "..."]] = None
    ...
    def forward(
        self,
        level: Float[Tensor, "..."],
        deformation: Optional[Float[Tensor, "..."]] = None,
    ) -> Mesh:
...
class MarchingTetrahedraHelper(IsosurfaceHelper):
    def __init__(self, resolution: int, tets_path: str):
        ...
        self._all_edges: Optional[Integer[Tensor, "..."]] = None

    def normalize_grid_deformation(self, grid_vertex_offsets: Float[Tensor, "..."]) -> Float[Tensor, "..."]:
        return (
    ...
    @property
    def all_edges(self) -> Integer[Tensor, "..."]:
